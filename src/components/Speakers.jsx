...
const SPEAKERS = [
  {
    ...
    description:
      'Понад 10 років досвіду роботи в індустрії. Увійшли до рейтингу Forbes «30 до 30» та «Next 250».',
  ...
  },
  {
    ...
    description:
      'Працювала з компаніями Oh My Look!, G.Bar, Ювелірним Домом SOVA та брендом Bevza, Blast Out Studio. Співпрацювала з Martini Ukraine, Планета кіно, Forbes, Have A Rest та іншими.',
    photo: '/speakers/ovcharenko.jpg',
  },
  {
    id: 4,
    name: 'Василь Ябрик',
    role: 'Серійний підприємець, інвестор і ментор',
    description:
      "Власник YMG Group — екосистеми, що об'єднує 9 брендів: Viper Gym, Моесо, Файно Фрут, Крайна, Ісе Land, Container, Сакура та Norma Food.",
    photo: '/speakers/vasil.jpg',
  },
  {
    id: 3,
    name: 'Людмила Богуш',
    ...
    description:
      'Героїня Forbes Ukraine, менторка міжнародних спільнот та фондів. Експертка з планування та створення стратегій розвитку бізнесу.',
