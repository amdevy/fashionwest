export default function TicketCard({ type, title, price, description, features }) {
  return (
    <div className='bg-white border border-[#d9d9d9] p-10 flex flex-col gap-4 min-h-[520px] hover:border-[#6b3b40] hover:-translate-y-1 hover:shadow-md transition-all duration-300'>
      <div>
